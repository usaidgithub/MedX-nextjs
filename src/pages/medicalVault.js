...
const MedicalVault = () => {
    ...
    const getViewableUrl = (fileUrl) => {
        return file.url.replace("/raw/", "/upload/");
    };
    useEffect(() => {
        fetchDocuments();
    }, []);
    ...
    return (
        <>
            ...
            {/* The main content container now uses 'pt-32' for a larger top padding, ensuring visibility below the header. */}
            <div className="min-h-screen bg-gray-900 text-gray-100 pt-32 p-8 font-sans antialiased">
